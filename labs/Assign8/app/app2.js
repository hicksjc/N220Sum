...
function changeDiv2() {
     //by putting "div2" in the changeStyle() we are assigning the id of div1 to the variable of e1 then using it in the document.getElementById
    changeStyle("div2");
}
function changeDiv3() {
     //by putting "div3" in the changeStyle() we are assigning the id of div1 to the variable of e1 then using it in the document.getElementById
    changeStyle('div3');
}